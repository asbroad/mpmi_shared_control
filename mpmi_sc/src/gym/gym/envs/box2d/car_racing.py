...
class CarRacing(gym.Env):
    ...
    def reset(self):
        ...
        self.initial_state = self.track[0][1:4]
    ...
    def step(self, action):
        ...
        system_state = [self.car.hull.position[0], self.car.hull.position[1], self.car.hull.angle, self.car.hull.linearVelocity[0], self.car.hull.linearVelocity[1], self.car.hull.angularVelocity]

        # return self.state, step_reward, done, {}
        return system_state, step_reward, done, {}
